...
function onNewMessage(message) {
   ...
   * }
    ...
    if (!messageData.uaid || !messageData.dt || !messageData.dt.wakeup_hostport || !messageData.dt.wakeup_hostport.ip || !messageData.dt.wakeup_hostport.port || !messageData.dt.mobilenetwork || !messageData.dt.mobilenetwork.mcc || !messageData.dt.mobilenetwork.mnc) {
